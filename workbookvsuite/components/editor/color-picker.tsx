...
const ColorPicker = ({ color, onChange, label, name, roundSwatch = false }: ColorPickerProps) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative flex size-7 shrink-0 cursor-pointer items-center justify-center overflow-hidden border shadow-sm",
          roundSwatch ? "rounded-full" : "rounded-md"
        )}
