...
const CssImportDialog: React.FC<CssImportDialogProps> = ({ open, onOpenChange, onImport }) => {
  ...
  return (
    <ResponsiveDialog open={open} onOpenChange={onOpenChange}>
      <ResponsiveDialogContent className="flex max-h-[90dvh] flex-col overflow-hidden shadow-lg sm:max-h-[min(640px,80dvh)] sm:max-w-[620px] sm:pt-6">
...
.dark {
  ...
  /* And more */
            ...
            `}
              className="min-h-[320px] max-h-[430px] field-sizing-fixed resize-none overflow-y-auto rounded-2xl border-2 border-input bg-white p-4 font-mono text-sm text-foreground shadow-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/20 dark:bg-background"
              value={cssText}
              onChange={(e) => {
        ...
        <ResponsiveDialogFooter className="mt-4 border-t bg-background px-6 py-4 sm:mt-0">
