...
export const themeStylePropsSchema = z.object({
  ...
  "destructive-muted": z.string().optional(),
  positive: z.string().optional(),
  "positive-foreground": z.string().optional(),
  "positive-muted": z.string().optional(),
  attention: z.string().optional(),
  "attention-foreground": z.string().optional(),
  "attention-muted": z.string().optional(),
  brand: z.string().optional(),
  "brand-foreground": z.string().optional(),
  border: z.string().describe("The color for borders."),
  "border-selected": z.string().optional(),
  input: z.string().describe("The background color for input fields."),
  ring: z.string().describe("The color for focus rings."),
  "ring-offset": z.string().optional(),
  "chart-1": z.string(),
  "chart-2": z.string(),
  "chart-3": z.string(),
  "chart-4": z.string(),
